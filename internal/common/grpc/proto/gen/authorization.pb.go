...
const file_authorization_proto_rawDesc = "" +
	...
	"\bpassword\x18\x02 \x01(\tR\bpassword2\xa3\x01\n" +
	"\x14AuthorizationService\x12E\n" +
	"\tAuthorize\x12 .gophkeeper.AuthorizationRequest\x1a\x16.google.protobuf.Empty\x12D\n" +
	"\bRegister\x12 .gophkeeper.AuthorizationRequest\x1a\x16.google.protobuf.EmptyB\x1bZ\x19gophkeeper/gen;gophkeeperb\beditionsp\xe8\a"
...
var file_authorization_proto_depIdxs = []int32{
	...
	1, // 2: gophkeeper.AuthorizationService.Authorize:output_type -> google.protobuf.Empty
	1, // 3: gophkeeper.AuthorizationService.Register:output_type -> google.protobuf.Empty
